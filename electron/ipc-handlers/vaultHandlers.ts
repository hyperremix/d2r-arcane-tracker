...
function sanitizeFilter(filter?: VaultItemFilter): VaultItemFilter {
  ...
  if (safeFilter.characterName !== undefined) {
    assert(typeof safeFilter.characterName === 'string', 'characterName must be a string');
  }
...
function itemMatchesFilter(
  ...
  if (
    ...
    item.characterName.toLowerCase() !== filter.characterName.toLowerCase()
  ) {
    return false;
  }
